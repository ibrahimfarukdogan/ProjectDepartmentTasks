...
Users.hasMany(TaskComments, {foreignKey: 'commenter_user_id',as: 'writtenComments',onDelete: 'SET NULL'});
...
//Tasks.belongsTo(TasksComments, {foreignKey: 'assigned_dept_id',as: 'assignedDepartment',onDelete: 'CASCADE'});
